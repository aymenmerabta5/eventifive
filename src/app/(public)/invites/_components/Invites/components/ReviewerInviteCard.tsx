...
export function ReviewerInviteCard({ invite, onAccept, onReject, isDisabled }: ReviewerInviteCardProps) {
	return (
		<div
			className={cn(
		...
		>
			<div className="space-y-1">
				...
				<div className="text-muted-foreground text-xs">Status: {invite.status}</div>
			</div>
