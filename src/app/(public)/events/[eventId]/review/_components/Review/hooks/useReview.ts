...
export function useReview({ submissionId }: UseReviewProps) {
	...
	const derivedRecommendation: ReviewRecommendation | undefined = useMemo(() => {
	...
	}, [existingReview, rating, derivedRecommendation, user, submitReviewMutation, submissionId, comments]);
