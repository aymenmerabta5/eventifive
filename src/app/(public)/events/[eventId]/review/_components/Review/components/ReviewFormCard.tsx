...
export function ReviewFormCard({
	...
	const canSubmit = !isReadOnly && rating !== null && recommendationToShow !== undefined;
				...
				<div className="space-y-3">
					...
					<div className="space-y-2 rounded-lg border border-border/60 bg-muted/30 px-4 py-3">
						<Slider
							...
							step={1}
							value={[displayRating]}
							onValueChange={(values: number[]) => onRatingChange(values[0] ?? DEFAULT_RATING)}
							disabled={isReadOnly}
							className="w-full"
						/>
					...
					<div className="flex items-center justify-between gap-3">
						...
						{recommendationToShow ? (
							<div className="flex items-center gap-2">
								...
								<Badge
									variant={recommendationToShow === "accept" ? "default" : "destructive"}
								>
