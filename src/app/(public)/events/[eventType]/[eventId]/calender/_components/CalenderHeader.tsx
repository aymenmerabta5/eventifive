...
import { getTodaySessions } from "@/mock-data/sessions";
...
export function CalendarHeader() {
  ...
  const meetingsCount = todaySessions.filter(
    (e) =>
      e.title.toLowerCase().includes("call") ||
      e.title.toLowerCase().includes("meeting")
  ).length;
  const sessionsCount = todaySessions.length - meetingsCount;
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="hidden md:block text-xs text-muted-foreground">
                  ...
                  {meetingsCount !== 1 ? "s" : ""} and {sessionsCount} session
                  {sessionsCount !== 1 ? "s" : ""} today
                </p>
              </div>
            </div>
                ...
                <DropdownMenuContent align="end" className="w-80">
                  ...
                  <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                    ...
                    <p className="text-xs text-muted-foreground pl-6">
                      Opening Keynote has been confirmed for tomorrow at 9:00 AM
                    </p>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                    <div className="flex items-center gap-2 w-full">
                  ...
                  <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                    ...
                    <p className="text-xs text-muted-foreground pl-6">
                      Panel Discussion time has been changed to 2:00 PM
                    </p>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="flex flex-col items-start gap-1 p-3 cursor-pointer">
                    <div className="flex items-center gap-2 w-full">
                    ...
                    <p className="text-xs text-muted-foreground pl-6">
                      Dr. Sarah Chen joined the AI Research session
                    </p>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
