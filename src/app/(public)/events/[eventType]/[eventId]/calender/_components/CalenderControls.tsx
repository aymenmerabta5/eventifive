...
export function CalendarControls() {
  ...
  const [eventTypeFilter, setEventTypeFilter] = useState<"all" | "with-meeting" | "without-meeting">("all");
  const [participantsFilter, setParticipantsFilter] = useState<"all" | "with-participants" | "without-participants">("all");
