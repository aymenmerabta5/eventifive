...
function mapEventType(urlType: string): "congress" | "seminar" | "workshop" | "scientific_meeting" | "conference" | "symposium" {
  const mapping: Record<string, "congress" | "seminar" | "workshop" | "scientific_meeting" | "conference" | "symposium"> = {
    "congress": "congress",
    "seminar": "seminar",
    "workshop": "workshop",
...
export default async function EventTypePage({
  ...
  return <EventTypePageClient eventType={eventType} eventTypeParam={eventTypeParam} />;
}
