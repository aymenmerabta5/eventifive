 ...
 * - Otherwise = rejected
 */
export const computeFinalDecision = (reviewers: ReviewerLike[]): FinalDecision => {
	...
	return { acceptedCount, rejectedCount, pendingCount, finalStatus } as FinalDecision;
};
 ...
 */
export const isWorkshopSubmission = (keywords?: string | null, title?: string | null): boolean => {
