 ...
 *
 * Uses shimmer animation for loading feedback.
 * The skeleton matches the actual StatCard dimensions and structure
 */
 ...
 *
 * Matches the structure of UserTableRow with placeholder elements
 */
function SkeletonTableRow() {
  return (
    <div className="border-border/30 flex items-center gap-4 border-b px-6 py-4">
      ...
      <div className="bg-muted/40 h-5 w-24 rounded-full" />
...
/**
 * Loading state component for the Users page
 *
 * This component displays skeleton loaders matching the structure of:
 * - UsersHeader (header skeleton)
 * - UserStatsCards (4 stat card skeletons)
 * - UsersTable (table skeleton with rows)
 *
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="bg-muted/30 h-10 w-28 rounded-lg" />
        </div>
      </div>
