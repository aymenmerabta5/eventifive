  ...
  return (
    <div className="flex min-h-full items-center justify-center px-4 py-6 sm:px-6 sm:py-8">
      ...
      >
        ...
        {/* Main card */}
        <div className="border-border/40 bg-card/90 dark:border-border/20 dark:bg-card/70 relative rounded-xl border p-4 shadow-lg backdrop-blur-xl sm:p-5 dark:shadow-xl">
